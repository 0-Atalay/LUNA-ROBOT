...
Ben bir **SÜPER** grup yönetim botuyum.
...
*Main* komutlar mevcuttur:
 ...
 - /settings:
   - in PM: tüm desteklenen modüller için ayarlarınızı size gönderecek🤡.
   - in a group: tüm sohbet ayarlarıyla sizi pm'ye yönlendirecek🤡.
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝YARDIM🤝",
...
def help_button(bot: Bot, update: Update):
    ...
    try:
        ...
        if excp.message == "Mesaj değiştirilmedi😴":
            ...
            pass
        elif excp.message == "bu mesajı silemezsiniz 🤡":
            pass
        else:
    ...
    if user:
        ...
        if CHAT_SETTINGS:
            ...
            dispatcher.bot.send_message(user_id,
                                        text="{} için hangi modülün ayarlarını kontrol etmek istersiniz?".format(
                                            chat_name),
                                        reply_markup=InlineKeyboardMarkup(
...
def settings_button(bot: Bot, update: Update):
    ...
    try:
        if mod_match:
            ...
            chat = bot.get_chat(chat_id)
            query.message.reply_text("Merhaba! {} için epeyce ayar var - devam edin ve ne olduğunu seçin "
                                     "senin ilgilendiğin.".format(chat.title),
                                     reply_markup=InlineKeyboardMarkup(
            ...
            chat = bot.get_chat(chat_id)
            query.message.reply_text(text=" Merhaba! {} için epeyce ayar var - devam edin ve ne olduğunu seçin"
                                          "senin ilgilendiğin.".format(escape_markdown(chat.title)),
                                     parse_mode=ParseMode.MARKDOWN,
        ...
        if excp.message == "Mesan Değiştirilmedi 🤡":
            pass
        elif excp.message == "Query_id_invalid":
            pass
        elif excp.message == "Bu Mesajı Silemezsin😴":
            pass
        else:
